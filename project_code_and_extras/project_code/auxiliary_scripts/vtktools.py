"""This file is used for preprocessing data in vtu format: get nodes values, nodes neighborhood, ...
This file was downloaded directly from: https://github.com/FluidityProject/fluidity/blob/main/python/vtktools.py 
Nothing in this single file is the student's work.   """
